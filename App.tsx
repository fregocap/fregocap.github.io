...
const ScrollToTop = () => {
  // handled by router usually but explicit scroll restoration is good
  return null;
};
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
              ...
              <div>
                ...
                <ul className="space-y-5 text-sm font-medium">
                  {/* Using standard anchor tags for footer navigation just to be safe or Link. Let's use Link */}
                  {/* Actually, for simplicity and ensuring router context, Link is better inside Router */}
                  {/* But to avoid huge refactor of footer, I'll keep the structure but change buttons to Links */}
